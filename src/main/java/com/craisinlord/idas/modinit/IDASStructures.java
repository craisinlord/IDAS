...
public final class IDASStructures {
    ...
    public static RegistryObject<StructureFeature<?>> OVER_LAVA_NETHER_STRUCTURE = STRUCTURE_FEATURES.register("idas_over_lava_nether_structure", () -> new OverLavaNetherStructure<>(IDASOverLavaNetherConfig.CODEC));
    ...
    public static void setupStructures() {
        ...
        StructureFeatureAccessor.getSTEP().put(OVER_LAVA_NETHER_STRUCTURE.get(), GenerationStep.Decoration.SURFACE_STRUCTURES);
