...
public class IDASOverLavaNetherConfig implements FeatureConfiguration {

    public static final Codec<IDASOverLavaNetherConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
    ...
    ).apply(instance, IDASOverLavaNetherConfig::new));
    ...
    public IDASOverLavaNetherConfig(Holder<StructureTemplatePool> startPool, int size,
