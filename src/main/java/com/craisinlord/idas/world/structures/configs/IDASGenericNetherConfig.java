package com.craisinlord.idas.world.structures.configs;
...
public class IDASGenericNetherConfig extends IDASGenericConfig {

    public static final Codec<IDASGenericNetherConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
    ...
    ).apply(instance, IDASGenericNetherConfig::new));

    public final boolean highestLandSearch;
    public final int ledgeSpotOffset;
    public final int liquidSpotOffset;

    public IDASGenericNetherConfig(Holder<StructureTemplatePool> startPool, int size, int minYAllowed,
