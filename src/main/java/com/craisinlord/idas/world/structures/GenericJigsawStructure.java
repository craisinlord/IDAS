...
public class GenericJigsawStructure <C extends IDASGenericConfig> extends AbstractBaseStructure<C> {
    ...
    protected static <CC extends IDASGenericConfig> boolean isGenericFeatureChunk(PieceGeneratorSupplier.Context<CC> context) {
    ...
    public static <CC extends IDASGenericConfig> Optional<PieceGenerator<CC>> generateGenericPieces(PieceGeneratorSupplier.Context<CC> context) {
        CC config = context.config();
