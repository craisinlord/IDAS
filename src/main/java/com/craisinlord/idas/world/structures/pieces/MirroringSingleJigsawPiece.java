...
import com.craisinlord.idas.modinit.IDASStructurePieces;
...
public class MirroringSingleJigsawPiece extends SinglePoolElement {
    ...
    public MirroringSingleJigsawPiece(SinglePoolElement singleJigsawPiece, Mirror mirror) {
        this(((SinglePoolElementAccessor)singleJigsawPiece).idas_getTemplate(), ((SinglePoolElementAccessor)singleJigsawPiece).idas_getProcessors(), singleJigsawPiece.getProjection(), mirror);
    }
    ...
    public StructurePoolElementType<?> getType() {
        return IDASStructurePieces.MIRROR_SINGLE;
    }
