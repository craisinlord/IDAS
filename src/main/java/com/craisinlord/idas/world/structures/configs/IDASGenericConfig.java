...
public class IDASGenericConfig implements FeatureConfiguration {

    public static final Codec<IDASGenericConfig> CODEC = RecordCodecBuilder.create(instance -> instance.group(
    ...
    ).apply(instance, IDASGenericConfig::new));
    ...
    public IDASGenericConfig(Holder<StructureTemplatePool> startPool, int size, int minYAllowed,
