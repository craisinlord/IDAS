...
public final class StructureMapTradesEvents {
        ...
        public static void onVillagerTradesEvent(VillagerTradesEvent event) {
            ...
            if (currentVillager != null && IDAS.structureMapManager.VILLAGER_MAP_TRADES.containsKey(currentVillager.toString())) {
                for (VillagerMapObj mapTrade : IDAS.structureMapManager.VILLAGER_MAP_TRADES.get(currentVillager.toString())) {
        ...
        public static void onWandererTradesEvent(WandererTradesEvent event) {
            for (Map.Entry<WanderingTraderMapObj.TRADE_TYPE, List<WanderingTraderMapObj>> tradeEntry : IDAS.structureMapManager.WANDERING_TRADER_MAP_TRADES.entrySet()) {
