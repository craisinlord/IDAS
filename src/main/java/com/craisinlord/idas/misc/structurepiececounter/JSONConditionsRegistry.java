...
public final class JSONConditionsRegistry {
    ...
    public static final ResourceKey<Registry<Supplier<Boolean>>> RS_JSON_CONDITIONS_KEY = ResourceKey.createRegistryKey(new ResourceLocation(IDAS.MODID, "json_conditions"));
    ...
    public static void registerTestJSONCondition() {
        ...
        Registry.REGISTRY.getOptional(new ResourceLocation(IDAS.MODID, "json_conditions"))
            .ifPresent(registry -> Registry.register(
                (Registry<Supplier<Boolean>>)registry,
                new ResourceLocation(IDAS.MODID, "test"),
                () -> false));
    }
